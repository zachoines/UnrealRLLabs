...
private:
    ...
    static constexpr float VelAlign_Threshold = 0.0f;    // speed below which we punish
    static constexpr float VelAlign_Threshold_Punishment = 0.00f; // small negative, scaled by dt
    static constexpr float VelAlign_Min = -20.0f;   // clamp “away” speed
    ...
    static constexpr float DistImprove_Threshold = 0.00f;  // minimal improvement each step
    ...
    static constexpr float FALL_OFF_PENALTY = -0.0001f;
