...
# New Parameters for Hermite-Gaussian Modes
DECAY_FACTOR = .1   # Decay factor for the columns (0 < DECAY_FACTOR <= 1)
V_MAX = 1.00        # Maximum speed of column height change per frame
...
# Initialize Hermite polynomial orders (integers >= 0)
agent_n_orders = np.random.randint(0, 3, N_AGENTS)
...
def update_plot(frame_number):
    global agent_positions, agent_directions, agent_speeds, agent_amplitudes, agent_frequencies, agent_phases, agent_n_orders, agent_m_orders, heights
